    ...
    return (
        <div className="w-full h-full flex flex-col items-center">
            ...
            <svg width={width} height={height} className="overflow-visible">
                ...
                {/* Labels */}
                <text x={centerX + boxWidth / 2 + 10} y={whiskerHighPos + padding + 5} fill="#94a3b8" fontSize="11">
                    {whisker_high.toFixed(1)}
                </text>
                <text x={centerX + boxWidth / 2 + 10} y={q3Pos + padding + 5} fill="#a78bfa" fontSize="11">
                    Q3: {q3.toFixed(1)}
                </text>
                <text x={centerX + boxWidth / 2 + 10} y={medianPos + padding + 5} fill="#f472b6" fontSize="11">
                    Med: {median.toFixed(1)}
                </text>
                <text x={centerX + boxWidth / 2 + 10} y={q1Pos + padding + 5} fill="#a78bfa" fontSize="11">
                    Q1: {q1.toFixed(1)}
                </text>
                <text x={centerX + boxWidth / 2 + 10} y={whiskerLowPos + padding + 5} fill="#94a3b8" fontSize="11">
